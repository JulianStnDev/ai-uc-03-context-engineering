...
Spalten: `quellen_ok` automatisch (Scoring-Regel; bei veraltet ist ein Zitat der alten Preisseite ein Fehler; bei luecke ok, wenn nichts zitiert) · `kernaussage_ok` Judge, ohne luecke · `treu` Judge, Faithfulness gegen den mitgegebenen Kontext · `luecke_ok` Judge, nur luecke · `alles_ok` alle zutreffenden Spalten ok

**Ein Lauf, kleine Stichprobe:** Eine Frage entspricht 4 Prozentpunkten (n=27), in den Typ-Spalten 20–33. Die Judge-Urteile sind noch nicht kalibriert (siehe `judge_stichprobe.md`).

## Gesamt

| Variante | quellen_ok | kernaussage_ok | treu | luecke_ok | **alles_ok** |
|---|---|---|---|---|---|
| sections | 21/27 (78%) | 17/23 (74%) | 24/27 (89%) | 4/4 (100%) | **18/27 (67%)** |
| contextual | 21/27 (78%) | 15/23 (65%) | 25/27 (93%) | 3/4 (75%) | **17/27 (63%)** |
| articles | 25/27 (93%) | 21/23 (91%) | 21/27 (78%) | 4/4 (100%) | **18/27 (67%)** |
| corpus | 26/27 (96%) | 21/23 (91%) | 21/27 (78%) | 4/4 (100%) | **20/27 (74%)** |

## alles_ok nach typ

| Variante | aehnlich (n=4) | einfach (n=12) | luecke (n=4) | mehrquellen (n=4) | veraltet (n=3) |
|---|---|---|---|---|---|
| sections | 3/4 | 8/12 | 4/4 | 1/4 | 2/3 |
| contextual | 3/4 | 9/12 | 3/4 | 1/4 | 1/3 |
| articles | 3/4 | 8/12 | 4/4 | 2/4 | 1/3 |
...
| Variante | aehnlich (n=4) | einfach (n=12) | luecke (n=4) | mehrquellen (n=4) | veraltet (n=3) |
|---|---|---|---|---|---|
| sections | 4/4 | 9/12 | 4/4 | 2/4 | 2/3 |
| contextual | 4/4 | 11/12 | 4/4 | 1/4 | 1/3 |
| articles | 4/4 | 12/12 | 4/4 | 3/4 | 2/3 |
| corpus | 4/4 | 12/12 | 4/4 | 4/4 | 2/3 |
...
|---|---|---|---|
| sections | 12/17 | 3/5 | 3/5 |
| contextual | 12/17 | 3/5 | 2/5 |
| articles | 12/17 | 2/5 | 4/5 |
...
| Variante | entwurf (n=17) | mensch (n=5) | mensch_korrigiert (n=5) |
|---|---|---|---|
| sections | 14/17 | 3/5 | 4/5 |
| contextual | 14/17 | 3/5 | 4/5 |
| articles | 17/17 | 4/5 | 4/5 |
| corpus | 17/17 | 4/5 | 5/5 |
...
|---|---|---|---|
| sections | 3 (#3, #5, #10) | 2/3 | 3/3 |
| contextual | 4 (#3, #5, #10, #26) | 1/3 | 1/3 |
| articles | 2 (#3, #5) | 2/3 | 3/3 |
| corpus | 2 (#3, #10) | 2/3 | 2/3 |
...
|---|---|
| sections | #3 (quellen_ok), #4 (quellen_ok, kernaussage_ok), #9 (treu), #10 (quellen_ok, kernaussage_ok, treu), #14 (quellen_ok, kernaussage_ok), #18 (quellen_ok, kernaussage_ok), #19 (quellen_ok, kernaussage_ok), #22 (treu), #27 (kernaussage_ok) |
...
| articles | #2 (treu), #3 (quellen_ok), #4 (treu), #10 (quellen_ok, kernaussage_ok), #12 (treu), #15 (treu), #18 (kernaussage_ok), #21 (treu), #27 (treu) |
| corpus | #3 (quellen_ok, kernaussage_ok), #10 (kernaussage_ok, treu), #14 (treu), #15 (treu), #18 (treu), #21 (treu), #23 (treu) |
